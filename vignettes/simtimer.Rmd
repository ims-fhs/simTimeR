...
For the transformation into the relative timescale (`date_time` -> `sim_datetime`) use the corresponding function `sim_datetime()`. This function expects an `origin_date` of choice to be predefined. This `origin_date` should be earlier in time than the following `date_time`-elements.
